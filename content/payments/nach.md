...
Call the [FPDocs, create mandate](https://fintechprimitives.com/api/#create-an-e-mandate) with the following json.
...
Call the [FPDocs, authorize mandate]() with the mandate ID from the previous step.
...
You can use the [FPDocs, simulation](https://fintechprimitives.com/api/#post-mandate-simulation) to move the mandate into different states to help you during the integration process. For example, use the following json to simulate the mandate to `APPROVED` state.
