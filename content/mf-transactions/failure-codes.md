...
| `payment_not_received`|  Payment details for this order has not been recieved by AMC. Check refund status  with the payment provider if amount debited.| purchase |
